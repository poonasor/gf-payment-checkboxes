...
(function($) {
    ...
    function loadProductChoices(field) {
        ...
        if (field.choices && field.choices.length > 0) {
            ...
            $.each(field.choices, function(index, choice) {
                addChoiceRow(choice.text || '', choice.value || '', choice.price || '', index);
            });
        } else {
    ...
    function addChoiceRow(label, value, price, index) {
        ...
        var container = $('#checkbox_product_choices_container');
        var newIndex = typeof index !== 'undefined' ? index : container.find('.gf-checkbox-product-choice-row').length;
        ...
        var i18n = window.gfCheckboxProductsAdmin ? window.gfCheckboxProductsAdmin.i18n : {};
        ...
        row.append(
            ...
            $('<div class="gf-choice-column gf-choice-column-actions">').append(deleteBtn)
        );
    ...
    function saveProductChoices() {
        ...
        $('#checkbox_product_choices_container .gf-checkbox-product-choice-row').each(function() {
